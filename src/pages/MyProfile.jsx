  ...
  return (
    <>
      ...
      <div className="flex sm:hidden flex-col h-screen items-center">
        ...
        <div className="flex h-[92px] w-[90%] bg-[#3366CC] mt-[11px] rounded-[10px]">
          <img
            className="h-[13px] w-[14px] m-[11px]"
            src="../src/assets/Content.svg"
          />

          <div className="text-[12px] font-Manrope text-[#EAEBF6] mt-[11px] w-full">
            {isEditing ? (
              <textarea
                value={intro} // Bind the textarea value
                onChange={e => setIntro(e.target.value)}
                className="bg-transparent text-white rounded-[2px] text-[11px] h-[70px] resize-none overflow-hidden"
                style={{
                  lineHeight: '1.5rem',
                  padding: '5px',
        ...
        <div className="h-[100px] w-[90%] bg-[#3366CC] mt-[11px] mb-[20px] rounded-[10px]">
