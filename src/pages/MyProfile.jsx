...
function MyProfile() {
  ...
  const [editableFields, setEditableFields] = useState({
    ...
    age: currentUser?.age || '27',
    education: currentUser?.education || 'Master in Business',
    status: currentUser?.status || 'Single',
    occupation: currentUser?.occupation || 'Sale Manager',
    location: currentUser?.location || 'Sydney',
  });
  ...
  const handleSaveClick = () => {
    console.log('Updated profile:', editableFields);
    setIsEditing(false);
  };
      ...
      <div className="flex ">
        <div className="flex min-h-screen flex-col">
          <div className="h-[360px] w-[230px] bg-[#3366CC] mt-[125px] ml-[35px] rounded-[10px]">
            <a className="flex flex-col items-center mt-[15px]">
              <div className="relative flex items-center justify-center w-full">
                <h2 className="font-Manrope font-extrabold text-[16px]">
                  {currentUser.username}
                </h2>
                <button
                  className="absolute right-[5px] opacity-0 hover:opacity-100"
          ...
          <div className="h-[100px] w-[230px] bg-[#3366CC] mt-[11px] ml-[35px] rounded-[10px]">
            ...
            <button className="absolute right-[5px] opacity-0 hover:opacity-100 mt-[11px] mr-[5px]">
                  <img
